...
foreach ($data as $cdata) :
    ...
    <div class="detail locality">
        <h3>Locality</h3>
        <p>World Geographical Scheme for Recording Plant Distributions</p>
        <?php
    ...
    <div class="detail material">
        ...
        <p>
            <?php
            echo $this->Format->detailValue('Voucher: ', $cdata['Material']['voucher_specimen_no']);
            echo $this->Format->detailValue('Voucher deposited in: ', $cdata['Material']['deposited_in']);
            ?>
        </p>
    </div>
