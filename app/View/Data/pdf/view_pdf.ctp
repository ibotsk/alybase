...
foreach ($data as $d) :
    ...
    <div>
        ...
        ?>
        <p>
            <span class="label">Photo:</span><span class="value"><?php echo $d['Cdata']['photo'] ? 'yes' : 'no'; ?></span>
            <span class="label">Idiogram:</span><span class="value"><?php echo $d['Cdata']['idiogram'] ? 'yes' : 'no'; ?></span>
            <span class="label">Drawing:</span><span class="value"><?php echo $d['Cdata']['drawing'] ? 'yes' : 'no'; ?></span>
        </p>
        <?php if (!empty($d['Dna'])) : ?>
            <h4>DNA</h4>
            <?php
